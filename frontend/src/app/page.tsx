        ...
        <div className="bg-slate-50 min-h-screen font-sans selection:bg-blue-100 text-slate-900">
            ...
            <section className="relative pt-12 md:pt-20 pb-20 md:pb-32 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-20 pb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 opacity-90">
                        <div className="flex flex-col items-center group cursor-default">
                            <span className="text-[10px] md:text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-3 h-4 flex items-center">Powered by</span>
                        ...
                        <div className="flex flex-col items-center group cursor-default">
                            <span className="text-[10px] md:text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-3 h-4 flex items-center">Secured by</span>
                            <div className="h-10 md:h-12 flex items-center justify-center">
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-10 border border-gray-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-[#00b87b]/10 transition-all group relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="w-11 h-11 md:w-14 md:h-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-4 md:mb-6 text-[#2874ca]">
                                <Users size={22} />
                            </div>
                            ...
                            <ul className="space-y-2 md:space-y-3 mb-8 md:mb-10">
                                {['Instant USDC Settlements', 'No Bank Account Required', 'Build On-Chain Reputation'].map((item, i) => (
                                    <li key={i} className="flex items-center text-slate-600 font-medium text-sm md:text-base">
                                        <CheckCircle2 size={16} className="text-[#00b87b] mr-3 flex-shrink-0" />
                                        {item}
                                    </li>
                                ))}
                            </ul>
                            <button
                                ...
                                className="w-full bg-[#2874ca] hover:bg-[#1d5ca3] text-white py-3 md:py-4 rounded-xl font-bold text-base md:text-lg transition-all flex items-center justify-center gap-2 group-hover:scale-[1.02]"
                            >
                        ...
                        <div className="relative z-10">
                            ...
                            <ul className="space-y-2 md:space-y-3 mb-8 md:mb-10">
                                {['API-First Integration', 'Automated QA & Consensus', 'Pay only for Valid Work'].map((item, i) => (
                                    <li key={i} className="flex items-center text-slate-600 font-medium text-sm md:text-base">
                                        <CheckCircle2 size={16} className="text-[#2874ca] mr-3 flex-shrink-0" />
                                        {item}
                                    </li>
                                ))}
                            </ul>
                                ...
                                return (
                                    <div className="relative group/btn">
                                        <button
                                            ...
                                            className={`w-full py-3 md:py-4 rounded-xl font-bold text-base md:text-lg flex items-center justify-center gap-2 transition-all 
                                                ${canCreateCampaign
                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                        <div className="space-y-6 md:space-y-8">
                            <div>
                                ...
                                <p className="text-slate-500 leading-relaxed text-base md:text-lg">
                                    Automate your workforce. Integrate global payouts into your dApp or platform with just a few lines of code.
                                </p>
                            </div>
                            <div className="bg-[#1e293b] rounded-2xl p-5 md:p-6 shadow-2xl overflow-hidden font-mono text-xs md:text-sm relative group border border-slate-700">
                        ...
                        <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 border border-gray-100 shadow-xl relative overflow-hidden">
                            ...
                            <div className="space-y-4 md:space-y-6">
                                ...
                                <div className="bg-[#f0fdf4] rounded-xl p-4 md:p-5 border border-[#00b87b]/20 flex items-center justify-between">
                                    <div>
                                        <div className="text-xs font-bold text-[#00b87b] uppercase tracking-wider mb-1">Current APY</div>
                                        <div className="text-2xl md:text-3xl font-black text-slate-900">~5.12%</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Asset</div>
                                        <div className="text-xs md:text-sm font-bold text-slate-700">Short Duration Yield Utility Token</div>
                                    </div>
                                </div>
            ...
            <section id="how-it-works" className="py-16 md:py-24 bg-white border-t border-gray-100">
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative">
                        ...
                        {[
                            { icon: <Wallet size={22} />, step: '1. Connect & Deposit', desc: 'Businesses fund the smart contract vault with USDC. Capital is instantly secured on-chain.' },
                            ...
                            <div key={i} className="relative text-center group">
                                <div className="w-20 h-20 md:w-24 md:h-24 bg-white border border-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 shadow-xl shadow-blue-50 group-hover:scale-110 transition-transform duration-300">
                                    <div className={`w-10 h-10 md:w-12 md:h-12 ${item.green ? 'bg-[#f0fdf4]' : 'bg-blue-50'} rounded-full flex items-center justify-center ${item.green ? 'text-[#00b87b]' : 'text-[#2874ca]'}`}>
                                        {item.icon}
                                    </div>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                    <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
                        <div className="flex-1">
                            <div className="inline-block px-3 py-1 bg-blue-100 text-[#2874ca] rounded-full text-xs font-bold uppercase tracking-widest mb-4 md:mb-6">
                            ...
                            <div className="space-y-4 md:space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex gap-3 md:gap-4">
                                        <div className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#2874ca] flex-shrink-0">
                                            {item.icon}
                                        </div>
                                        <div>
            ...
            <section id="talent" className="py-16 md:py-24 bg-white border-t border-gray-100">
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                    <div className="flex flex-col md:flex-row-reverse gap-10 md:gap-16 items-center">
                        <div className="flex-1">
                            <div className="inline-block px-3 py-1 bg-green-100 text-[#00b87b] rounded-full text-xs font-bold uppercase tracking-widest mb-4 md:mb-6">
                                For Talent
                            </div>
                            ...
                            <div className="space-y-4 md:space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex gap-3 md:gap-4">
                                        <div className="w-10 h-10 md:w-12 md:h-12 bg-slate-50 rounded-xl shadow-sm flex items-center justify-center text-[#00b87b] flex-shrink-0">
                                            {item.icon}
                                        </div>
                                        <div>
                                            <h4 className="text-base md:text-lg font-bold text-slate-900">{item.title}</h4>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center bg-slate-50 p-3 rounded-xl border border-slate-100">
                                        <span className="text-xs md:text-sm text-slate-500">Data Labeling Task #892</span>
                                        <span className="text-xs md:text-sm font-bold text-[#00b87b]">+$2.50 USDC</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-slate-50 p-3 rounded-xl border border-slate-100">
                                        <span className="text-xs md:text-sm text-slate-500">Translation Task #104</span>
                                        <span className="text-xs md:text-sm font-bold text-[#00b87b]">+$15.00 USDC</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 md:gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-gray-100">
                        <div className="px-6 py-4">
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-2">Borderless</h3>
                            <p className="text-slate-500 text-sm md:text-base">Access talent in 150+ countries instantly.</p>
                        </div>
                        <div className="px-6 py-4">
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-2">Audited</h3>
                            <p className="text-slate-500 text-sm md:text-base">Bank-grade smart contracts & security.</p>
                        </div>
                        <div className="px-6 py-4">
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-2">Cost Efficient</h3>
                            <p className="text-slate-500 text-sm md:text-base">Save ~30% vs traditional BPO firms.</p>
                        </div>
                    </div>
                </div>
            </section>
